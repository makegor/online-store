...
import next from '../../../assecs/images/icons-next.png';
import prev from '../../../assecs/images/icons-prev.png';

let Paginator = ({ totalCount, pageSize, currentPage = 1, onPageChanged, portionSize = 2 }) => {
